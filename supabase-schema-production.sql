-- GPS Backend için Supabase tabloları (Master Database)
-- Versiyon: PRODUCTION 2.1 - Çalışan versiyonüo
...
-- Görev durumu değişiklik trigger'ı
